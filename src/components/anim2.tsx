...
const trans3 = (x: number, y: number) =>
    `translate3d(${x / 5.5 / DIVISOR}px,${y / 5.5 / DIVISOR}px,0)`;
const trans4 = (x: number, y: number) =>
    `translate3d(${x / 3.5 / DIVISOR}px,${y / 3.5 / DIVISOR}px,0)`;
const trans5 = (x: number, y: number) =>
    `translate3d(${x / 4.5 / DIVISOR}px,${y / 4.5 / DIVISOR}px,0)`;

export function Anim2(): JSX.Element {
